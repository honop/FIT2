...
function sound(){
    ...
    alert("満足だにゃ〜");
		b = '<a href="uranai3b.html"><input type="button" value="おや…？"></a>';
...
alert("貴方の運勢は…");
	for(var i=0; i<9; i++){
		if(mikuji==i){
			...
			document.getElementById('change1').innerHTML = '<p><a href="http://web.sfc.keio.ac.jp/~t18105ku/info2/uranai_game/nekomikuji_endb.html"><input type="button" value="次へ"></a></p>'
