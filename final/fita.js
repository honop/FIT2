...
function q1(){
  ...
  if((a.value=="1,4,7" && b.value=="20,14,8,2,-4" && c.value=="1,2,4,8,16,32,64,128")||(a.value=="1, 4, 7" && b.value=="20, 14, 8, 2, -4" && c.value=="1, 2, 4, 8, 16, 32, 64, 128")){
    alert("全問正解!")
    location.href="fit2a.html"
  }else{
    alert("ゲームオーバー!");
    a.value="1,4,7";
    b.value="20,14,8,2,-4";
    c.value="1,2,4,8,16,32,64,128";
    over.innerHTML='<a href="end1a.html"><input type="button" class="square_btn1" value="GAME OVER"></a>'
